...
public class ClientDAO {
    ...
    public ObservableList<Authors> authorsList() {
        ObservableList<Authors> authors = FXCollections.observableArrayList();
        Connection connection = null;
        try {
            connection = getConnection();
    ...
    public ObservableList<Publishers> publishersList() {
    ...
    public ObservableList<Books> booksList() {
    ...
    public ObservableList<Books> searchBooks(String title) {
        ObservableList<Books> books = FXCollections.observableArrayList();
        Connection connection = null;
        try {
            connection = getConnection();
